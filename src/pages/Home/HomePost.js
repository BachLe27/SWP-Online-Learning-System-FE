...
const HomePost = ({ post }) => {
   ...
   return (
      <div onClick={() => { navigate(`/post/${post.id}`) }} class="post-item mb-4 row border border-dark border-2 rounded-2 p-2" style={{ height: "200px" }}>
         <div class="post-img col-3 my-1 d-flex justify-content-center" width="270px" height="190px">
